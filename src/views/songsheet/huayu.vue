<template>
    <div class="tuijian">
        <div class="tuijian-item">
            <div class="tuijian-item-div" v-for="(item,index) in huayuList" :key="index">
...
export default {
    ...
    methods:{
        ...
        getJingpin(){
            this.$axios.get('/top/playlist?limit=33&order=hot&cat=华语').then((res)=>{
                this.huayuList = res.data.playlists
