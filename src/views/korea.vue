<template>
    <div class="korea">
        <div v-for="(item,index) in koreaList" :key="index" v-if="index<1">
        ...
        <div class="song-list">
            <div class="song-list">
                ...
                <div class="song-list-detail">
                    <div class="song-detail-content" v-for="(item,index) in koreaList" :key="index">
...
export default {
    ...
    methods:{
        getkorea(){
            this.$axios.get('/top/song?type=16').then((res)=>{
                // console.log(res)
                this.koreaList=res.data.data
                this.totalCount= res.data.data.length
                // console.log(this.koreaList[0])
            }).catch((err)=>{
                console.log(err)
            })
        },
