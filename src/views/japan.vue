<template>
    <div class="japan">
        <div v-for="(item,index) in japanList" :key="index" v-if="index<1">
        ...
        <div class="song-list">
            <div class="song-list">
                ...
                <div class="song-list-detail">
                    <div class="song-detail-content" v-for="(item,index) in japanList" :key="index">
...
export default {
    ...
    methods:{
        getjapan(){
            this.$axios.get('/top/song?type=8').then((res)=>{
                // console.log(res)
                this.japanList=res.data.data
                this.totalCount= res.data.data.length
                // console.log(this.japanList[0])
            }).catch((err)=>{
                console.log(err)
            })
        },
